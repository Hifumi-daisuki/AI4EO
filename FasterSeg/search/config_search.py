...
C.image_width = 160 # crop width after down_sampling in dataloader
...
C.train_scale_array = [0.4, 1, 1.5] # scale factors for augmentation during training
...
# C.pretrain = True
C.pretrain = "search-pretrain-256x256_F12.L16_batch3-20231109-110907"
########################################
...
if C.pretrain == True:
    C.batch_size = 3
    C.niters_per_epoch = max(C.num_train_imgs // 2 // C.batch_size, 200)
    C.lr = 2e-2
